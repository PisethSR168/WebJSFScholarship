    ...
    <section class="donation-gradient text-white py-20">
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto text-center" data-aos="fade-up">
                ...
                <p class="text-xl text-blue-100 mb-8">Your donation helps provide quality education to underprivileged
                    children in Cambodia.</p>
            </div>
        </div>
    </section>
            ...
            <div class="max-w-6xl mx-auto">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2">
                        <div class="bg-white dark:bg-slate-800 rounded-xl p-8 border border-slate-300 dark:border-slate-700 shadow-lg"
                            data-aos="fade-right">
                            ...
                            <div class="mb-8">
                                ...
                                <div id="custom-amount" class="hidden">
                                    ...
                                    <input type="number" min="5" step="0.01"
                                        class="form-input w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600"
                            ...
                            <!-- Billing Information -->
                            <div class="mb-8">
                                <h3 class="text-xl font-semibold mb-4 text-gray-800 dark:text-white">Billing Information
                                </h3>

                                <label class="flex items-center space-x-3 cursor-pointer mb-6">
                                    <input type="checkbox" name="organization_donation"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Country
                                            *</label>
                                        <select
                                            class="form-input w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600">
                            ...
                            <div class="mb-8">
                                ...
                                <div id="credit-card-details">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="md:col-span-2">
                                            <label
                                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Card
                                                Number *</label>
                                            <input type="text" required
                                                class="form-input w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600"
                                        ...
                                        <div>
                                            <label
                                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">CVV
                                                *</label>
                                            <input type="text" required
                                                class="form-input w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600"
                                                placeholder="123">
                                        ...
                                        <div>
                                            <label
                                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Expiration
                                                *</label>
                                            <div class="flex space-x-2">
                                                <select
                                                    class="form-input flex-1 px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600">
                            ...
                            <div class="space-y-4 mb-8">
                                ...
                                <label class="flex items-center space-x-3 cursor-pointer">
                                    <input type="checkbox" name="receive_emails" class="w-4 h-4 text-blue-600 rounded"
                                        checked>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 mb-6">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span
                                        class="text-2xl font-bold text-blue-600 dark:text-blue-400 donation-summary">$0.00</span>
                                </div>
                            </div>
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-white dark:bg-slate-800 rounded-xl p-6 border border-slate-300 dark:border-slate-700 shadow-lg"
                            data-aos="fade-left">
                            ...
                            <div class="space-y-4">
                                <div class="flex gap-3 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600 dark:text-gray-400">JSF Scholarship, Siem Reap, Cambodia</p>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600 dark:text-gray-400">
                                            <a href="tel:+85512225131"
                                                class="hover:text-blue-600 dark:hover:text-blue-400">(+855) 12 22 51 31</a>
                                        </p>
                                    </div>
                                </div>
                                <div class="flex gap-3 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600 dark:text-gray-400">
                                            <a href="mailto:neouwannen3@gmail.com"
                                                class="hover:text-blue-600 dark:hover:text-blue-400">neouwannen3@gmail.com</a>
                                        </p>
                                    </div>
                                </div>
                                <div class="flex gap-3 items-start">
